...
setup(name='theverse',
      ...
      package_data = {},
      description='Properties of our universe (and others) for generating problems with realistic parameters',
      ...
      license='BSD',
      keywords=['randomized problem', 'quiz', 'test', 'exam', 'assessment'],
      python_requires='>=3.6',
      install_requires=[
      ],
